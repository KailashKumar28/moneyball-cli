...
fn main() {
    ...
    if true {
        ...
        app.chat.push_tool(
            ...
            "",
            vec![
                "BRIEF  snapshot 2026-07-15  (7d window)".into(),
                "".into(),
                "  > Namma Mane".into(),
                "    spend Rs.14,067/d  meta 166  crm 154  qual 35 (5.00/d)  Rs.2,813/q".into(),
                "    L->Q 22.7%   gap   5.0".into(),
                "  > Valmark CityVille".into(),
                "    spend Rs.4,838/d  meta 27  crm 24  qual 2 (0.29/d)  Rs.16,934/q".into(),
                "    L->Q  8.3%   gap   9.7".into(),
                "  > Purva Sparkling Spring by Fincity".into(),
                "    spend Rs.15,136/d  meta 53  crm 43  qual 8 (1.14/d)  Rs.13,244/q".into(),
                "    L->Q 18.6%   gap   8.9".into(),
                "  > Primus by Fincity".into(),
                "    spend Rs.3,165/d  meta 14  crm 13  qual 1 (0.14/d)  Rs.22,152/q".into(),
                "    L->Q  7.7%   gap   9.9".into(),
                "".into(),
                "FEASIBILITY  6.6 q/day @ Rs.37,206/day = Rs.5,662/q -  goal 40/day".into(),
